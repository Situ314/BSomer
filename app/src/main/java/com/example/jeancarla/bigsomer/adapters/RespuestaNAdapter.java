...
import com.example.jeancarla.bigsomer.activities.Formulario_Historial_Negativa;
 ...
 */
public class RespuestaNAdapter extends RecyclerView.Adapter<RespuestaNAdapter.RespuestaNViewHolder>
        implements ItemClickListener{

    private Dialog dialog;
    private List<RespuestaN> items;
 ...
 */
    ...
    public RespuestaNAdapter(List<RespuestaN> items, Context context) {
    ...
    @Override
    public RespuestaNViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.historial_item, viewGroup, false);
        return new RespuestaNViewHolder(v, this);
    }

    @Override
    public void onBindViewHolder(RespuestaNViewHolder viewHolder, int i) {
    ...
    public void onItemClick(View view, int position) {
        ...
        final String nombre = items.get(position).getNombre();
        final String ci = items.get(position).getCi();
        final String cargo = items.get(position).getCargo();
        final String comentario = items.get(position).getComentarios();

        Intent i = new Intent(context, Formulario_Historial_Negativa.class);
    ...
    public static class RespuestaNViewHolder extends RecyclerView.ViewHolder
            implements View.OnClickListener, OnMapReadyCallback
    {
        ...
        public RespuestaNViewHolder(View v, ItemClickListener listener)
        {
            super(v);
