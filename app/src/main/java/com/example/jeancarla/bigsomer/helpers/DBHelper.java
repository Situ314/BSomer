...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        db.execSQL("create table tarea(id_ver varchar primary key,tipo_verificacion varchar,id_tipo varchar,solicitante varchar, nombre varchar, ci varchar,direccion varchar,zona varchar,ciudad varchar, nombre_empresa varchar,  cliente  varchar, referencias varchar,ub_latitud varchar,  ub_longitud varchar , medidor varchar)");
