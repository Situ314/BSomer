...
public class CaptureSignature extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        String id_ver = getIntent().getStringExtra("id_ver");

        File sdCard = Environment.getExternalStorageDirectory();

        tempDir = Environment.getExternalStorageDirectory() + "/" + getResources().getString(R.string.external_dir) + "/";
        ContextWrapper cw = new ContextWrapper(getApplicationContext());
        File directory = new File(sdCard.getAbsolutePath()	+ "/Bigsomer_firmas_bgvs");
        //File directory = cw.getDir(getResources().getString(R.string.external_dir), Context.MODE_PRIVATE);

        Log.i("A dondeeee", tempDir);
        ...
        current = id_ver+"_firma.jpg";
        foto_firma=Environment.getExternalStorageDirectory()+ "/Bigsomer_firmas_bgvs/" +current;
